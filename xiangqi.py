...
class Board(Canvas):
    ...
    def board_setup(self):
        ...
        if self.board_status.get_active_player() == 'RED':
            player_text = '1st Player'
        else:
            player_text = '2nd Player'
        self.create_text(4, board_size + offset - 2, text=player_text, anchor=SW, fill='#f6e198')
    ...
    def draw_pieces(self):
        ...
        for location in pieces:
            ...
            if piece.get_player().upper() == 'RED':
                self.create_oval(pixel_location[0] + 2, pixel_location[1] + 2, pixel_location[0] + piece_size[0] - 2, pixel_location[1] + piece_size[1] - 2, fill='#ffaa2e')
            else:
                self.create_oval(pixel_location[0] + 2, pixel_location[1] + 2, pixel_location[0] + piece_size[0] - 2, pixel_location[1] + piece_size[1] - 2, fill='#ffe0bd')
    ...
    def click(self, event):
        ...
        if self.selected:
            ...
            self.board_status.make_move(self.last_position, position)
